...
import { checkInvertData, useDashboardData, ReportsLineChartConfig, DashboardReportContainer, ReportsLineChart, DashboardStatisticItem } from 'entities/dashboard-data';
