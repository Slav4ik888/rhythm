import { DashboardViewEntities } from 'entities/dashboard';
import { deleteAllChildrenFromViewEntities } from '..';
...
describe('deleteAllChildrenFromViewEntities', () => {
  test('Data is valid', () => {
    ...
    deleteAllChildrenFromViewEntities(entities, '1');
...
// npm run test:unit delete-all-children-from-view-entities.test.ts
