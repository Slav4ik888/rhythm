...
interface Action {
  type: 'SET_MODE' | 'IS_OPEN_CONFIGURATOR' | 'TOGGLE_SIDEBAR_MINI' | 'TOGGLE_SIDEBAR_HIDDEN' | 'TOGGLE_SIDEBAR' | 'TOGGLE_SIDEBAR_COLOR'
  value: any
}
...
const setIsSidebar          = (dispatch: Dispatch, value: boolean)          => dispatch({ type: 'TOGGLE_SIDEBAR',            value });
