...
describe('prepareDataForChart', () => {
  ...
  test('periodType === greatest', () => {
    ...
    expect(prepareDataForChart(monthItemData as DashboardStatisticItem<number>, allActiveDates_1, 'week'))
      .toEqual([1, 2, 3, 4, 5]);
  });
  ...
  test('periodType !== greatest, isFirstGreatestDate = false', () => {
    ...
    const result = prepareDataForChart(monthItemData as DashboardStatisticItem<number>, allActiveDates_1, 'week');
  ...
  test('periodType !== greatest, isFirstGreatestDate = true', () => {
    ...
    const result = prepareDataForChart(monthItemData as DashboardStatisticItem<number>, allActiveDates_2, 'week');
  ...
  test('periodType !== greatest, isFirstGreatestDate = true', () => {
    ...
    const result = prepareDataForChart(monthItemData as DashboardStatisticItem<number>, allActiveDates_3, 'week');
